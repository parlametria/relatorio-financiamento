...
processa_doacoes_partidarias_tse <- 
  function(receitas_datapath = here::here("raw_data/dados_tse/receitas_candidatos_2018_BRASIL.csv.zip"),
           candidatos_datapath = here::here("raw_data/dados_tse/consulta_cand_2018_BRASIL.csv.zip")) {
...
import_receita_tse_modelo_antigo <- function(datapath = here::here("raw_data/dados_tse/receitas_candidatos_2014_brasil.txt.zip")) {
  library(tidyverse)
  library(here)
...
processa_doacoes_tse <- function(
  receitas_datapath = here::here("raw_data/dados_tse/receitas_candidatos_2018_BRASIL.csv.zip"),
  candidatos_datapath = here::here("raw_data/dados_tse/consulta_cand_2018_BRASIL.csv.zip"),
  ano = 2018,
  summarized = TRUE) {
...
filtra_doacoes_parlamentares_exercicio <- function(ano = 2018, casa_origem = "camara") {
  library(tidyverse)
  library(here)
  source(here("crawler/receitas/utils_receitas.R"))
  ...
  parlamentares <- read_csv(here("raw_data/parlamentares.csv")) %>% 
