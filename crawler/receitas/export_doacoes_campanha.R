...
source(here::here("crawler/receitas/analyzer_receitas_tse.R"))
...
option_list = list(
  make_option(c("-a", "--ano"), type="character", default="2018",
              ...
              metavar="character"),
  make_option(c("-o", "--out"), type="character", default=here::here("raw_data/receitas/parlamentares_doadores.csv"),
